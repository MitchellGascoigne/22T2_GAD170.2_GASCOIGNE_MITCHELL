...
public class LevelingSystem : MonoBehaviour
{
    ...
    public void SetDefaultValues()
    {
        ...
        int currentXPThreshold = (currentXp * 100);
    }
    ...
    {
        // So let's increase our current level, but let's also recalculate our XP threshold
        // to take into account the new level we've just gained. 
        if (currentXp > currentXPThreshold)
        {
            currentLevel++;
            Debug.Log("The new Xp Threshold is " + currentLevel);
        }
