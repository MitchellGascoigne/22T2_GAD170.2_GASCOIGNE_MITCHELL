...
public class StatsSystem : MonoBehaviour
{
    ...
    public void ChangeHealth(float amount)
    {
        ...
        playerHealth -= amount;
        //Debug.Log("PlayerHealth = " + playerHealth); Already Debug.Logged in  TestImplementation()
    ...
    public void DistributePhysicalStatsOnLevelUp(int PointsPool)
    {
        ...
        Debug.Log("upgradeStrength =" + upgradeStrength);
        Debug.Log("upgradeAgility =" + upgradeAgility);
        Debug.Log("upgradeIntelligence =" + upgradeIntelligence);
    }
    ...
    public void TestDistributePhysicalStatsOnLevelUp()
    {
        Debug.Log(string.Format("The new physical stats are str {0}, agil {1}, int {2}, the dancing stats " +
            "are style {3}, luck {4}, rhythm {5}", strength, agility, intelligence, style, luck, rhythm));
    }
}
    #endregion
